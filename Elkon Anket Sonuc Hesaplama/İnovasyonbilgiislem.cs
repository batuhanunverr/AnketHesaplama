...
{
    public partial class İnovasyonbilgiislem : Form
    {
        int sayac = 1;
        soru soru1 = new soru();
        soru soru2 = new soru();
       ...
       soru45.kkatil = Convert.ToInt32(textBox221.Text);
        ...
        public int hesaplama(soru q)
        {
            ...
            if (ibre > 1 && ibre < 2)
            {
                ...
                f.ortalamalistbox.Items.Add("İnovasyonBilgiİşlem Bölümün " + sayac + ".inci Sorusu için Ortalama Cevap =  'Kesinlikle Katılmıyorum - Katılmıyorum Arasındadır' ");
            }
            if (ibre > 2 && ibre < 3)
            {
                MessageBox.Show("Bu Bölümün Bu Sorusu için Ortalama Cevap = 'Katılmıyorum - Kararsızım Arasındadır' ", "soru" + sayac);
                f.ortalamalistbox.Items.Add("İnovasyonBilgiİşlem Bölümün " + sayac + ".inci Sorusu için Ortalama Cevap = 'Katılmıyorum - Kararsızım' ");
            }
            if (ibre > 3 && ibre < 4)
            {
                MessageBox.Show("Bu Bölümün Bu Sorusu için Ortalama Cevap = 'Kararsızım - Katılıyorum Arasındadır' ", "soru" + sayac);
                f.ortalamalistbox.Items.Add("İnovasyonBilgiİşlem Bölümün " + sayac + ".inci Sorusu için Ortalama Cevap = 'Kararsızım - Katılıyorum' ");
            }
            if (ibre > 4 && ibre < 5)
            {
                MessageBox.Show("Bu Bölümün Bu Sorusu için Ortalama Cevap = 'Katılıyorum - Kesinlikle Katılıyorum Arasındadır' ", "soru" + sayac);
                f.ortalamalistbox.Items.Add("İnovasyonBilgiİşlem Bölümün " + sayac + ".inci Sorusu için Ortalama Cevap =  'Katılıyorum - Kesinlikle Katılıyorum Arasındadır' ");
            }
            if (ibre == 1)
            {
                MessageBox.Show("Bu Bölümün Bu Sorusu için Ortalama Cevap = 'Kesinlikle Katılmıyorum' ", "soru" + sayac);
                f.ortalamalistbox.Items.Add("İnovasyonBilgiİşlem Bölümün " + sayac + ".inci Sorusu için Ortalama Cevap = 'Kesinlikle Katılmıyorum ' ");
            }
            if (ibre == 2)
            {
                MessageBox.Show("Bu Bölümün Bu Sorusu için Ortalama Cevap = 'Katılmıyorum' ", "soru" + sayac);
                f.ortalamalistbox.Items.Add("İnovasyonBilgiİşlem Bölümün " + sayac + ".inci Sorusu için Ortalama Cevap = ' Katılmıyorum ' ");
            }
            if (ibre == 3)
            {

                MessageBox.Show("Bu Bölümün Bu Sorusu için Ortalama Cevap = 'Kararsızım' ", "soru" + sayac);
                f.ortalamalistbox.Items.Add("İnovasyonBilgiİşlem Bölümün " + sayac + ".inci Sorusu için Ortalama Cevap =  'Kararsızım' ");
            }
            if (ibre == 4)
            {
                MessageBox.Show("Bu Bölümün Bu Sorusu için Ortalama Cevap = 'Katılıyorum' ", "soru" + sayac);
                f.ortalamalistbox.Items.Add("İnovasyonBilgiİşlem Bölümün " + sayac + ".inci Sorusu için Ortalama Cevap = 'Katılıyorum' ");
            }
            if (ibre == 5)
            {
                MessageBox.Show("Bu Bölümün Bu Sorusu için Ortalama Cevap = 'Kesinlikle Katılıyorum' ", "soru" + sayac);
                f.ortalamalistbox.Items.Add("İnovasyonBilgiİşlem Bölümün " + sayac + ".inci Sorusu için Ortalama Cevap = 'Kesinlikle Katılıyorum' ");
            }
            ...
            f.standartsapmalistbox.Items.Add("İnovasyonBilgiİşlem Bölümün " + sayac + ".inci Sorusu için Standart Sapması = " + x.ToString());
            ...
            if (medyan == 1)
            {
                ...
                f.medyanlistbox.Items.Add("İnovasyonBilgiİşlem Bölüm İçin" + sayac + ". Sorunun Medyanı = Kesinlikle Katılmıyorum");
            }
            if (medyan == 2)
            {
                MessageBox.Show("Bu Bölüm İçin" + sayac + ". Sorunun Medyanı = Katılmıyorum");
                f.medyanlistbox.Items.Add("İnovasyonBilgiİşlem Bölüm İçin" + sayac + ". Sorunun Medyanı = Katılmıyorum");
            }
            if (medyan == 3)
            {
                MessageBox.Show("Bu Bölüm İçin" + sayac + ". Sorunun Medyanı = Kararsızım");
                f.medyanlistbox.Items.Add("İnovasyonBilgiİşlem Bölüm İçin" + sayac + ". Sorunun Medyanı = Kararsızım ");
            }
            if (medyan == 4)
            {
                MessageBox.Show("Bu Bölüm İçin" + sayac + ". Sorunun Medyanı = Katılıyorum");
                f.medyanlistbox.Items.Add("İnovasyonBilgiİşlem Bölüm İçin" + sayac + ". Sorunun Medyanı = Katılıyorum ");
            }
            if (medyan == 5)
            {
                MessageBox.Show("Bu Bölüm İçin" + sayac + ". Sorunun Medyanı = Kesinlikle Katılıyorum");
                f.medyanlistbox.Items.Add("İnovasyonBilgiİşlem Bölüm İçin" + sayac + ". Sorunun Medyanı = Kesinlikle Katılıyorum");
            }
